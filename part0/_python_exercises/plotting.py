...
def sine(fig, ax):
  # MISSING: Plot a sine function between 0 and 2*np.pi. See example function identity().
  pass


def normal(fig, ax):
  # MISSING: Plot the PDF of the standard Normal distribution between -3 and 3. See example function identity().
  pass
